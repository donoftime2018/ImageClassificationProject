...
export default function About(){
    ...
    return (
        <div className="about-container">
            <div className="font-[700] text-3xl font-[poppins]">
                <p>About Image Express</p>
            </div>

            <div className="font-[poppins] mr-0 ml-0 pr-0 pl-0">
                <p>Image Express is a modern, user-friendly web application designed to classify images
